...
COVERAGE_MODULES = [
    ...
    'options_product.admin',
    'options_product.discount',
    'options_product.models',
    #'options_product.sitemap',
    'options_product.templatetags.plata_product_tags',
    'options_product.views',
